...
def image_upload(request):
    if 'file' in request.FILES:
        ...
        link = 'https://' + getattr(settings, 'AWS_STORAGE_BUCKET_NAME', 'sengkuyung-dev') + '.s3-' + getattr(settings, 'AWS_S3_REGION_NAME', 'ap-southeast-1') + '.amazonaws.com' + path
...
def file_upload(request):
    if 'file' in request.FILES:
        ...
        link = 'https://' + getattr(settings, 'AWS_STORAGE_BUCKET_NAME', 'sengkuyung-dev') + '.s3-' + getattr(settings,
                                                                                                              'AWS_S3_REGION_NAME',
